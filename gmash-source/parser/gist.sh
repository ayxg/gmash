...
Sub-Commands:
  ...
  create                                Push given files as gists to GitHub. Adds a title.md   and readme.md by default.
  clone                                 Clones a gist to the local filesystem.
  recover                               Recover a user's gist(s) from GitHub remotes as git repos.
  upload                                Create gists from a set of files or folders and clone them back asgit repos.
